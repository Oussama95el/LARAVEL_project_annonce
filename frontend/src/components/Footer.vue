<template>
        <div>
          <footer class="bg-grey text-center text-white">
            <!-- Grid container -->
            <div class="container p-4 pb-0">
              ...
              <section class="mb-4">
                ...
                <!-- Google -->
                <a
                    class="btn btn-primary instagram btn-floating m-1"
                    href="#"
                    role="button"
                >
            ...
            <div class="text-center p-3 bg-dark">
              © 2020 Copyright:
              <a class="text-white" href="https://mdbootstrap.com/">Art Gall 2022, WorldWide </a>
            </div>
            <!-- Copyright -->
          </footer>
        </div>
