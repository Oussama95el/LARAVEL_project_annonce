<template>
      <div>
        <header class="header">
          ...
          <h1 class="heading">
            <span class="sub-sub">share with the world your Requests</span>
          </h1>
        </header>
        <!--        Section of demandes  -->
        ...
        <div class="card-container">
          ...
          <section class="container-content ">
            <div class="card d-flex" v-for="item in requests" :key="item.id">
              ...
              <p class="card-text m-0"><small class="text-muted">Added at {{ item.created_at.slice(0,10) }}</small></p>
              <p class="card-text m-0"><small class="text-muted">{{ item.type }}</small></p>
              </div>
            </div>
            <!--   pagination   -->
          </section>
                ...
                <form action="#" @submit="submit" enctype="multipart/form-data">
                  ...
                  <div class="mb-3">
                    ...
                    <select class="form-select" v-model="form.type" id="select">
                      ...
                      <option value="offer" disabled>Offer</option>
...
export default {
  ...
  mounted() {
    ...
    const endpoint = `http://127.0.0.1:8000/api/demand`
    ...
    // if (this.requests[0].id != window.localStorage.getItem('user_id') ){
  ...
  methods: {
    ...
    submit: function () {
      ...
      const endpoint = `http://127.0.0.1:8000/api/demand/${this.form.id ?? ""}`
    ...
    destroy(id) {
      ...
      const endpoint = `http://127.0.0.1:8000/api/demand/${id}`
